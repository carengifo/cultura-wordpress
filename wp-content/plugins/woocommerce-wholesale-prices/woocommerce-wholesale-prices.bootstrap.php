...
if ( in_array( 'woocommerce/woocommerce.php' , apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) {
    ...
    // Add custom variation bulk action options
    add_action( 'woocommerce_variable_product_bulk_edit_actions' , array( $wc_wholesale_prices , 'addVariationCustomBulkActionOptions' ) );

    // Execute custom variation bulk action options
    add_action( 'woocommerce_bulk_edit_variations' , array( $wc_wholesale_prices , 'executeVariationCustomBulkActions' ) , 10 , 4 );
    ...
    add_action( 'woocommerce_product_options_pricing' , array( $wc_wholesale_prices , 'addSimpleProductCustomFields' ) , 11 );
    ...
    add_action( 'woocommerce_process_product_meta_simple' , array( $wc_wholesale_prices , 'saveSimpleProductCustomFields' ) );
